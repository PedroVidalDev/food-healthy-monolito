...
export const PaymentHeaderContainer = styled.View`
  display: grid;
...
`
export const PaymentHeaderRollback = styled.TouchableOpacity`
  width: 24px;
  height: 24px;
  border-radius: 12px;
  align-items: center;
...
`
export const PaymentHeaderSubtitle = styled.Text`
