...
export const TextSupportHeader = styled.View`
...
export const SupportDescriptionTitle = styled.View`
  font-family: ${({ theme }) => theme.FONT_FAMILY.BALOO2.BALOO2_SEMIBOLD};
  font-size: ${({ theme }) => theme.FONT_SIZE.XG}px;
`

export const TextSupportDescription = styled.View`
...
export const SupportOptionsTextContainer = styled.View`
  ...
  `
export const SupportOptionsTitle = styled.View`
  flex-direction: coluum:
  font-family: ${({ theme }) => theme.FONT_FAMILY.BALOO2.BALOO2_SEMIBOLD};
  font-size: ${({ theme }) => theme.FONT_SIZE_MD}px;
`

export const SupportOptionsText = styled.View`
  flex-direction: coluum:
  font-family: ${({ theme }) => theme.FONT_FAMILY.BALOO2.BALOO2_MEDIUM};
  font-size: ${({ theme }) => theme.FONT_SIZE.SM}px;
